...
export class TestGearFormatter extends Formatter implements IFormatter {
  client: IClient;
  ...
  async createNewAutotest(
    ...
    autotestPost.automaticCreationTestCases = this.client.getConfig().automaticCreationTestCases;
